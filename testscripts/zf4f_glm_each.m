...
struct('dataname', 'resim/zf4f_glm_stats_session2fullsof_resim', 'variantname', '', 'indexmapper', 1:4, 'startsecs', 0, 'endsecs', 600, 'resimuldur', 0), ...
struct('dataname', 'resim/zf4f_glm_stats_session3fullsof_resim', 'variantname', '', 'indexmapper', 1:4, 'startsecs', 0, 'endsecs', 600, 'resimuldur', 0), ...
struct('dataname', 'resim/zf4f_glm_stats_session2fullsof_resimasolo', 'variantname', '', 'indexmapper', [1], 'startsecs', 0, 'endsecs', 600, 'resimuldur', 0), ...
struct('dataname', 'resim/zf4f_glm_stats_session3fullsof_resimasolo', 'variantname', '', 'indexmapper', [1], 'startsecs', 0, 'endsecs', 600, 'resimuldur', 0), ...
};
