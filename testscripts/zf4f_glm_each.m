...
for whichnlf = 1:length(nlfuns)
	...
	for whichset=1:size(setses,2)
		...
		[numcalls.(runname), resultspos.(runname), resultsval.(runname), negloglis.(runname)] = testscript_GLM_zf4f(d.dataname, d.variantname, d.indexmapper, d.startsecs, d.endsecs, nlfun);
	end
